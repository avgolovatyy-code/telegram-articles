...
class HeuristicDemandProvider:
    ...
    _INTENT_PRIOR: ClassVar[dict[str, float]] = {
        ...
        "self_guided_routes": 0.35,
        "ticket_with_audio": 0.5,
        "themed_walking_tour": 0.4,
        "first_time_in_city": 0.4,
        "with_kids_in_city": 0.35,
        "self_guided_in_city": 0.4,
    }
